...
export class ProjectsService {
    ...
    projects: Project[] = [
      {id: 1, name: "Integrating Kubiya AI in your AWS Account ", pictures: ["../../assets/kubiya.png"], projectLink: "https://medium.com/@phanindra.sangers/kubiya-ai-generative-ai-for-aws-38977a62e8fd", summary: "Integrating Kubiya AI into your AWS Account ", description: "Kubiya Is an Generative AI tool", tags: [Tag.CONTAINERS,Tag.DEVOPS,Tag.AWS]},
